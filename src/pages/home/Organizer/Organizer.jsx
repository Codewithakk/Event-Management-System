                ...
                <div className='flex flex-col md:flex-row md:gap-10 items-center'>
                    ...
                    <div className='flex-1 bg-white md:-ml-20 p-12 rounded-md'>
                        ...
                        <p className='text-secondary my-4 text-justify'>
                            Akshay Events : Where your vision meets perfection. From corporate conferences to intimate gatherings, we specialize in flawless event management. With our expertise, let us handle the stress while you enjoy every moment. Contact us today and let&apos;s create magic together.
                        </p>
